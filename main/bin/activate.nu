...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/lanneq/Documents/lanneq_dev/grokking_Deep_Learning/main'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/lanneq/Documents/lanneq_dev/grokking_Deep_Learning/main/bin/deactivate.nu'
